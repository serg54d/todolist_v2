...
test("status of specified task should be changed", () => {
    let updateModel = { todolistId: "todolistId2", taskId: "2", domainModel: { status: TaskStatus.New } }
...
test("title of specified task should be changed", () => {
    let updateModel = { todolistId: "todolistId2", taskId: "2", domainModel: { title: "coffee" } }
    const action = updateTask.fulfilled(updateModel, "requestId", updateModel)
...
test("property with todolistId should be deleted", () => {
    const endState = tasksReducer(
        startState,
        removeTodolist.fulfilled({ id: "todolistId2" }, "requestId", "todolistId2"),
    )
